...
```bash
curl -fsSL https://raw.githubusercontent.com/jjlinares/ralph/master/install.sh | bash
```

Or manually:
```bash
curl -fsSL https://raw.githubusercontent.com/jjlinares/ralph/master/ralph.sh -o /usr/local/bin/ralph
